...
class _RadioButtonPageState extends State<RadioButtonPage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _jobOptions = [
    {'value' : 'Admin', 'icon': Icons.support_agent, 'color': Color(0xff2196F3), 'description': 'Mengelola Data'},
    {'value': 'Guru', 'icon' : Icons.school, 'color': Color(0xFF9C27B0), 'description' : 'Mendidik Generasi'},
    {'value': 'Programer', 'icon': Icons.code, 'color' : Color(0xFF4CAF50), 'description' : 'Mengembangkan Software'},
    {'value': 'Pengusaha', 'icon': Icons.business, 'color': Color(0xFFF44336), 'description': 'Mengelola Bisnis'},
    {'value': 'Designer', 'icon' : Icons.design_services, 'color': Color(0xFF00BCD4), 'description' : 'Kreativitas Visual'},
  ];

  final List<Map<String, dynamic>> _workTypeOptions =[
    {'value': 'Full Time', 'subtitle': 'Bekerja 40 jam/minggu', 'icon': Icons.work, 'color': Color(0xFF00897B), 'benefits': ['Asuransi kesehatan', 'Tunjangan hari raya']},
    {'value': 'Part Time', 'subtitle': 'Bekerja < 40 jam/minggu', 'icon': Icons.access_time, 'color': Color(0xFF0288D1), 'benefits': ['Jadwal fleksibel', 'Liburan panjang']},
    {'value': 'Freelance', 'subtitle': 'Pekerja lepas', 'icon': Icons.laptop, 'color': Color(0xFF7B1FA2), 'benefits': ['Kerja remote', 'Rate per project']},
    {'value': 'Kontrak', 'subtitle': 'Perjanjian waktu tertentu', 'icon': Icons.description, 'color': Color(0xFFE65100), 'benefits': ['Bonus kontrak', 'Evaluasi berkala']},
  ];
